...
<div class="ui-shell">
    <div class="ui-inner">
        <header class="ui-header">
            <div class="ui-badge ui-badge--compact">Docs</div>
            <div>
                <h1 class="ui-title"><?= htmlspecialchars($title, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?></h1>
                <p class="ui-subtitle">Выберите страницу документации из списка ниже.</p>
            </div>
        </header>
        <div class="ui-content">
            <ul class="ui-list">
                <?php foreach ($items as $item): ?>
                    <li><a class="ui-link" href="<?= htmlspecialchars($item['path'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?>"><?= htmlspecialchars($item['title'], ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
